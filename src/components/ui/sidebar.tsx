...
>(
  (
    ...
    if (!isMounted) {
      // Prevent hydration mismatch by not rendering the sidebar on the server if we can't know the mobile state.
      // The provider will have a default state that might not match the cookie.
      return null;
    }
